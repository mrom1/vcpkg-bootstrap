# example
#
# The project on the "example" branch works as published: configure, vcpkg in the expected
# place, build, run, and a second configure that reuses everything.
#
#   git clone -b example . _example
...
set(REQUIRED_INPUTS VB_SCRIPT_DIR VB_EXAMPLE_DIR)
...
set(SOURCE "${VB_EXAMPLE_DIR}")
set(BUILD "${RUN_DIR}/build")
if(NOT EXISTS "${SOURCE}/CMakeLists.txt")
  fail("VB_EXAMPLE_DIR is not a checkout of the example branch: ${SOURCE}")
endif()
...
configure(first "${SOURCE}" "${BUILD}" CONTAINS "${using}")
root_check("${BUILD}")
build(first "${BUILD}")
run_main(first "${BUILD}")

reconfigure_check(second "${SOURCE}" "${BUILD}")
build(second "${BUILD}")
