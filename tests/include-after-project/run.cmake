...
#
# vcpkg-bootstrap is fetched after project(). The toolchain can no longer be changed, so the
# script only warns and does nothing; vcpkg_bootstrap_install() warns instead of failing with
# "Unknown CMake command". No vcpkg is cloned and the project still builds.
#
#   cmake -DVB_SCRIPT_DIR=<checkout of main> -P tests/include-after-project/run.cmake

set(CASE include-after-project)
set(CASE_MODES OFF)                 # VB_ISOLATED values this case runs with
...
configure(first "${CASE_DIR}" "${BUILD}"
  CONTAINS "Included after project\\(" "vcpkg is not set up for this build"
